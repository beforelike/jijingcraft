...
This repository contains project-specific skills for Codex, specifically the **Multi Search Engine** skill installed from ClawHub (gpyangyoujun/multi-search-engine).

## Multi Search Engine Skill

**Location**: `.Codex/skills/multi-search-engine/`
...
- `.Codex/skills/multi-search-engine/skill.yaml` - Skill metadata and trigger conditions
- `.Codex/skills/multi-search-engine/SKILL.md` - Detailed documentation
